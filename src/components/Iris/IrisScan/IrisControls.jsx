...
const IrisControls = () => {
  const { ws, finalIrisZip } = useContext(ServerContext);
  ...
  return (
    <>
      <div className="w-full h-auto rounded-md flex">
        <div className="w-full bg-white h-full rounded-md border-t-4 shadow-custom border-primary py-6 px-10 flex flex-col justify-center items-center space-y-4">
          ...
          <div className="w-full flex flex-col  justify-center">
            ...
            <div className="flex justify-around">
              <button
                onClick={() => ws.send("start_iris_scan")}
              ...
              <button
                onClick={() => {
                  ws.send("stop_iris_scan");

                  //  we need to look for a better approch...
                  setTimeout(() => ws.send("iris_submit"), 3000);
                  // ws.send("iris_submit");
                }}
